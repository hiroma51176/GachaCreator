...
mix.js('resources/js/app.js', 'public/js')
    .js('resources/js/my-function.js', 'public/js')
    ...
    .js('resources/js/data-validation/number-only.js', 'public/js/data-validation')
    ...
    // .js('resources/js/run-view/create-prize.js', 'public/js/run-view')
